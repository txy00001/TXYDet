...
import sys
sys.path.append("./")
from txydet.evaluator import build_evaluator
from txydet.model.detector import build_model
from txydet.data.dataset import build_dataset
from txydet.data.collate import custom_collate_function
from txydet.trainer import build_trainer
from txydet.util import mkdir, Logger, cfg, load_config
import os
import torch
import logging
import argparse
