...
from txydet.model.module.init_weights import normal_init
...
class AnchorHead(nn.Module):
    ...
    def get_anchors(self, featmap_sizes, img_shapes, device='cuda'):  # checked!
        ...
        for i in range(num_levels):
            ...
            #print(":featmap_sizes:",featmap_sizes[i],":anchor_strides:",self.anchor_strides[i])    
            multi_level_anchors.append(anchors)
        #print("multi_level_anchors:",multi_level_anchors)    
        anchor_list = [multi_level_anchors for _ in range(num_imgs)]
        #print("anchor_list:",anchor_list)
        #print("for i in range(num_levels)")
