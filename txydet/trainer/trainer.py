...
import warnings
import torch
from txydet.util import mkdir, DataParallel, load_model_weight, save_model, MovingAverage, AverageMeter
...
class Trainer:
    ...
    def run_epoch(self, epoch, data_loader, mode):
        ...
        for iter_id, meta in enumerate(data_loader):
            ...
            #print("meta['img_info']['id']:",meta['img_info']['id'])
            ...
            #santiago
            #pass this number to the scheduler
            
            total_loss+=loss.item()
            #print("global iter_id,loss procedure:",iter_id,global_loss)
